    ...
    <div class="mt-5">
        ...
        <b-row class="mt-5">
            ...
            <b-col cols="12" md="4">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit iste consectetur, quidem eos totam
                accusamus assumenda minima quo rerum culpa voluptatum commodi suscipit repudiandae laudantium, voluptate error?
                Laborum, delectus cumque.</p>
